...
const docs_obj = {
  editUrl:
    'https://github.com/KushajveerSingh/Exploring-Apple-Development/edit/main/',
...
const title = 'Exploring Apple Development';
...
const config: Config = {
  ...
  projectName: 'Exploring-Apple-Development',
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/KushajveerSingh/Exploring-Apple-Development',
            },
            {
              label: 'Instagram',
